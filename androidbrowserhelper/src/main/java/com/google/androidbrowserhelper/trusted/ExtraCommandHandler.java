...
/**
 * An interface for handling extraCommand in {@link TrustedWebActivityService}.
 */
public interface ExtraCommandHandler {
     ...
     */
    @NonNull
    Bundle handleExtraCommand(TrustedWebActivityService service, String commandName, Bundle args,
